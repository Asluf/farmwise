...
class reviewSoldProducts extends StatefulWidget {
  const reviewSoldProducts({super.key, required this.productproposalList});

  final ProductProposalDetails productproposalList;

  @override
  State<reviewSoldProducts> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<reviewSoldProducts> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Listed Product Overview"),
      ),
