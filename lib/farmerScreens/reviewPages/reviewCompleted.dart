...
class reviewCompleted extends StatefulWidget {
  const reviewCompleted({super.key, required this.proposalList});

  final ProposalDetails proposalList;

  @override
  State<reviewCompleted> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<reviewCompleted> {
