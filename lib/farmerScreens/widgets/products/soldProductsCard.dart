import 'package:farmwise/farmerScreens/reviewPages/products/reviewSoldProducts.dart';
import 'package:flutter/material.dart';
import 'package:farmwise/farmerScreens/data/productProposalList.dart';

class soldProductCard extends StatefulWidget {
  const soldProductCard({super.key, required this.productproposalList});

  final ProductProposalDetails productproposalList;

  @override
  State<soldProductCard> createState() => _soldProductCardState();
}

class _soldProductCardState extends State<soldProductCard> {
  @override
